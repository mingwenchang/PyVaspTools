    ...
    if argulen > 1:
        for arg in sys.argv[1:]:
            ...
            if 'outcar' in arg:
                ...
                print ("e.g. idealthermo.py P=1.00bar T=300K A=0.10A^2 spin=0 symmetry=1 geom=linear")
                print ("e.g. idealthermo.py OUTCAR P=1.00bar T=300K A=0.10A^2 spin=0 symmetry=1 geom=linear")
